...
1. Download zip
2. Extract Zip
3. Node modules is removed while zipping, do the step 4
4. at the directory of reactlab in the project, do npm install
...
Before you begin, if you run `npm start` and view the app in the browser, you'll notice that final react app. 
